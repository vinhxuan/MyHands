...
public class CartProductAdapter extends RecyclerView.Adapter<CartProductAdapter.HotProductViewHolder> {

    private Context context;
    ArrayList<HotProducts> hotProductsArrayList;
    //private List<DiscountedProducts> discountedProductsList;

    public CartProductAdapter(Context context, ArrayList hotProductsArrayList) {
        this.context = context;
        this.hotProductsArrayList = hotProductsArrayList;
    }
    @NonNull
    @Override
    public CartProductAdapter.HotProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CartProductAdapter.HotProductViewHolder holder, int position) {
